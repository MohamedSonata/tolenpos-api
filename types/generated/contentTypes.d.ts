...
export interface ApiAppReleaseChangeLogAppReleaseChangeLog
  extends Struct.CollectionTypeSchema {
  collectionName: 'app_release_change_logs';
  info: {
    displayName: 'AppReleaseChangeLog';
    pluralName: 'app-release-change-logs';
    singularName: 'app-release-change-log';
  };
  options: {
    draftAndPublish: true;
  };
  attributes: {
    architecture: Schema.Attribute.Enumeration<['x64', 'arm64', 'x86']> &
      Schema.Attribute.Required;
    changelogs: Schema.Attribute.Component<
      'release-change-log-i-tems.release-change-log-i-tems',
      true
    >;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::app-release-change-log.app-release-change-log'
    > &
      Schema.Attribute.Private;
    platform: Schema.Attribute.Enumeration<['windows', 'macos', 'linux']> &
      Schema.Attribute.Required;
    publishedAt: Schema.Attribute.DateTime;
    ...
    releaseNotes: Schema.Attribute.Component<
      ...
      true
    >;
    releaseType: Schema.Attribute.Enumeration<['stable', 'beta', 'alpha']> &
      Schema.Attribute.Required &
...
export interface ApiAppReleaseAppRelease extends Struct.SingleTypeSchema {
  collectionName: 'app_releases';
  info: {
    displayName: 'AppRelease';
    pluralName: 'app-releases';
    singularName: 'app-release';
  };
  options: {
    draftAndPublish: true;
  };
  attributes: {
    ...
    checksumAlgorithm: Schema.Attribute.Enumeration<
      ['sha256', 'sha512', 'md5']
    > &
      Schema.Attribute.Required &
      Schema.Attribute.DefaultTo<'sha256'>;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    deprecatedAt: Schema.Attribute.DateTime;
    ...
    isLatest: Schema.Attribute.Boolean & Schema.Attribute.DefaultTo<false>;
    linuxDownloadUrl: Schema.Attribute.String & Schema.Attribute.Required;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::app-release.app-release'
    > &
      Schema.Attribute.Private;
    macOsDownloadUrl: Schema.Attribute.String & Schema.Attribute.Required;
    minVersion: Schema.Attribute.String;
    platform: Schema.Attribute.Enumeration<['windows', 'macos', 'linux']> &
      Schema.Attribute.Required;
    publishedAt: Schema.Attribute.DateTime;
    releaseDate: Schema.Attribute.DateTime & Schema.Attribute.Required;
    releaseNotes: Schema.Attribute.RichText &
    ...
    releaseType: Schema.Attribute.Enumeration<['stable', 'beta', 'alpha']> &
      Schema.Attribute.Required &
      Schema.Attribute.DefaultTo<'stable'>;
    requiredUpdate: Schema.Attribute.Boolean &
      Schema.Attribute.DefaultTo<false>;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    version: Schema.Attribute.String &
      Schema.Attribute.Required &
      Schema.Attribute.Unique;
    windowsDownloadUrl: Schema.Attribute.String & Schema.Attribute.Required;
  };
}
...
export interface ApiLicenseLicense extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    expirationType: Schema.Attribute.Enumeration<['perpetual', 'expiring']>;
    expiresAt: Schema.Attribute.DateTime;
    isActive: Schema.Attribute.Boolean & Schema.Attribute.DefaultTo<false>;
    licenseKey: Schema.Attribute.String;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::license.license'
...
export interface ApiSubscriptionPlanSubscriptionPlan
  ...
  attributes: {
    ...
    features: Schema.Attribute.Component<'plan-features.plan-features', true>;
    isActive: Schema.Attribute.Boolean & Schema.Attribute.DefaultTo<true>;
    ...
    isUnlimitedProducts: Schema.Attribute.Boolean &
      Schema.Attribute.DefaultTo<false>;
    isUnlimitedRegisters: Schema.Attribute.Boolean &
      Schema.Attribute.DefaultTo<false>;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
...
export interface PluginUsersPermissionsUser
  ...
  attributes: {
    ...
    planType: Schema.Attribute.Enumeration<['FreeTrial', 'Pro', 'Enterprise']> &
      Schema.Attribute.DefaultTo<'FreeTrial'>;
...
declare module '@strapi/strapi' {
  export module Public {
    export interface ContentTypeSchemas {
      ...
      'api::app-release-change-log.app-release-change-log': ApiAppReleaseChangeLogAppReleaseChangeLog;
